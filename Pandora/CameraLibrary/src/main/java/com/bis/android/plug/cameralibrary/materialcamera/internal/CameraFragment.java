...
import com.bis.android.plug.cameralibrary.materialcamera.ICallback;
...
import com.bis.android.plug.cameralibrary.materialcamera.util.ImageUtil;
import com.bis.android.plug.cameralibrary.materialcamera.util.ManufacturerUtil;
...
import static com.bis.android.plug.cameralibrary.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.bis.android.plug.cameralibrary.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
...
//                    parameters.setRecordingHint(true);
    ...
    private void setCameraDisplayOrientation(Camera.Parameters parameters) {
        ...
        if (getCurrentCameraId() == Camera.CameraInfo.CAMERA_FACING_BACK) {
            faceBackCameraOrientation = info.orientation;
        } else if (getCurrentCameraId() == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            faceFrontCameraOrientation = info.orientation;
        }
    ...
    private boolean prepareMediaRecorder() {
        try {
            ...
            mMediaRecorder.setOrientationHint(getVideoOrientation(mInterface.getSensorPosition()));
...
//        }
    ...
    protected int getVideoOrientation(int sensorPosition) {
        ...
        switch (sensorPosition) {
            case MaterialCamera.SENSOR_POSITION_UP:
                degrees = 0;
                break; // Natural orientation
            case MaterialCamera.SENSOR_POSITION_LEFT:
                degrees = 90;
                break; // Landscape left
            case MaterialCamera.SENSOR_POSITION_UP_SIDE_DOWN:
                degrees = 180;
                break;// Upside down
            case MaterialCamera.SENSOR_POSITION_RIGHT:
                degrees = 270;
