...
import com.bis.android.plug.cameralibrary.materialcamera.TimeLimitReachedException;
...
public abstract class BaseCaptureActivity extends AppCompatActivity implements BaseCaptureInterface {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        if (!CameraUtil.hasCamera(this)) {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage(R.string.mcam_video_capture_unsupported)
    ...
    public final void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
            new AlertDialog.Builder(this)
                    .setTitle(R.string.mcam_permissions_needed)
                    .setMessage(R.string.mcam_video_perm_warning)
                    .setPositiveButton(android.R.string.ok, null)
                    .setOnDismissListener(new DialogInterface.OnDismissListener() {
                        @Override
                        public void onDismiss(DialogInterface dialog) {
    ...
    protected int sensorPosition = MaterialCamera.SENSOR_POSITION_UNSPECIFIED;
