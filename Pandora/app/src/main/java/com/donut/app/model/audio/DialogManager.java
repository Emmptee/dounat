...
public class DialogManager {
    ...
    public void recording(){
        if(dialog != null && dialog.isShowing()){ //显示状态
            ...
            mIcon.setImageResource(R.drawable.recorder_icon);
    ...
    public void wantToCancel() {
        if(dialog != null && dialog.isShowing()){ //显示状态
            ...
            mIcon.setImageResource(R.drawable.recorder_cancel);
            mLable.setText("松开手指，取消发送");
            mLable.setBackgroundResource(R.drawable.shape_half_rec_main);
        }
    }
