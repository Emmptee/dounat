...
public class L {
    ...
    private static boolean sLogSwitch       = BuildConfig.LOG_SWITCH; // log总开关
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = SysApplication.getInstance().getExternalCacheDir()
                        + File.separator + "log" + File.separator;
            } else {
                dir = SysApplication.getInstance().getCacheDir()
                        + File.separator + "log" + File.separator;
            }
        }
