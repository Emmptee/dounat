 ...
 */
public class FinalPkImageAdapter extends BaseAdapter
{
    private List<SubjectHistoryPKDetail> list;

    private Context mContext;

    public FinalPkImageAdapter(Context context, List<SubjectHistoryPKDetail>
            contentData)
    {
...
//        ImageLoaderHelper.displayImage(list.get(position).getImgUrl(),
//                    ImageLoaderHelper.optionsForCommon,
//                    holder.img);
        Glide.with(mContext)
