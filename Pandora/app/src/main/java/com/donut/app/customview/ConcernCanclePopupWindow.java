...
public class ConcernCanclePopupWindow extends PopupWindow
{
    ...
    public ConcernCanclePopupWindow(Activity context, OnClickListenerWithPosition itemsOnClick)
    {
        super(context);
        showView(context, itemsOnClick, DEFAULT_ACTION_ID);
    }

    public ConcernCanclePopupWindow(Activity context,
