...
public class CommentAdapter extends RecyclerView.Adapter<ViewHolder>
{
    ...
    public CommentAdapter(Context context, List<ContentComments> contentData, View footView,
                          View headView)
    {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position)
    {
        ...
        } else if (viewHolder instanceof ItemViewHolder)
        {
            ...
            final ContentComments comment = commentList.get(position - 1);
            Glide.with(context)
            ...
            if (subList != null && subList.size() > 0)
            {
                ...
                for (int i = 0; i < subList.size(); i++)
                {
                    ...
                    ll.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            onRecyclerViewListener.onComment(position-1,subPos);
                        }
                    });
            ...
            holder.mFavorNum.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    onRecyclerViewListener.onFavor(position - 1);
                }
            });
            holder.mCommentNum.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    onRecyclerViewListener.onComment(position-1, -1);
                }
            });
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    onRecyclerViewListener.onItemClick(comment.getCommentId());
                }
            });
        } else if (viewHolder instanceof FooterViewHolder)
        {
            ...
            if (noMoreData)
            {
                ...
                hold.text.setText(R.string.wish_detail_bottom);
                setNoMoreData(false);
            } else
            {
    ...
    class ItemViewHolder extends ViewHolder
    {
        public ItemViewHolder(View view)
        {
            ...
            mMidLinear=(AutoLinearLayout) view.findViewById(R.id.comment_item_mid_linear);
            mHeaderVip= (ImageView)view.findViewById(R.id.comment_item_header_vip);
        }
