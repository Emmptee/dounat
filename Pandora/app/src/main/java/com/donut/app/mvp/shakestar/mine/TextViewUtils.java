...
public class TextViewUtils extends android.support.v7.widget.AppCompatTextView{
    ...
    public TextViewUtils(Context context, AttributeSet attrs) {
        ...
        //获取具体属性值
        underLineColor = typedArray.getColor(R.styleable.UnderlineTextView_text_color, getTextColors().getDefaultColor());
        underlineHeight = (int)typedArray.getDimension(R.styleable.UnderlineTextView_text_height,
