...
public class WhitelistPlugin extends CordovaPlugin {
    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if ("content".equals(strNode)) {
                String startPage = xml.getAttributeValue(null, "src");
                allowedNavigations.addWhiteListEntry(startPage, false);
            } else if ("allow-navigation".equals(strNode)) {
            ...
            } else if ("allow-intent".equals(strNode)) {
                String origin = xml.getAttributeValue(null, "href");
                ...
                if (origin != null) {
                    if (external) {
                        L.w(LOG_TAG, "Found <access launch-external> within config.xml. Please use <allow-intent> instead.");
    ...
    public Boolean shouldAllowRequest(String url) {
        if (Objects.equals(Boolean.TRUE, shouldAllowNavigation(url))) {
            return true;
        }
