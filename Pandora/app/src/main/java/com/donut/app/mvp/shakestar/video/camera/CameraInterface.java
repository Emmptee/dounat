...
import com.donut.app.mvp.shakestar.video.camera.util.AngleUtil;
import com.donut.app.mvp.shakestar.video.camera.util.CameraParamUtil;
import com.donut.app.mvp.shakestar.video.camera.util.CheckPermission;
import com.donut.app.mvp.shakestar.video.camera.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private static final String TAG = "CameraInterface222";
    ...
    public static String videoFileAbsPath;
...
//        mCamera = Camera.open();
    ...
    public void doStartPreview(SurfaceHolder holder, float screenProp) {
        if (isPreviewing) {
            KLog.e("doStartPreview isPreviewing");
        }
        if (this.screenProp < 0) {
            KLog.e(screenProp + "小于0");
        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size previewSize = CameraParamUtil.getInstance().getPreviewSize(mParams
                        .getSupportedPreviewSizes(), 200, screenProp);
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), 600, screenProp);
                ...
                isPreviewing = true;
                KLog.e("previewSize预览宽度" + previewSize.width + "预览高度" + previewSize.height +
                        "pictureSize图片宽度" + pictureSize.width + "图片高度" + pictureSize.height +
                        "相机角度CameraAngle " + cameraAngle);
...
//
        KLog.e(TAG, angle + " = " + cameraAngle + " = " + nowAngle);
...
//        }
        KLog.e(TAG, "nowAngle" + nowAngle + "-----CameraAngle---" + cameraAngle + "-------angle____" + angle);
        if (SELECTED_CAMERA == CAMERA_FRONT_POSITION) {
            //手机预览倒立的处理
            if (cameraAngle == 270) {
                KLog.e("cameraAngle为270度");
                //横屏
                if (nowAngle == 0) {
                ...
                KLog.e("cameraAngle为" + cameraAngle);
...
/*        videoFileName = "video_" + System.currentTimeMillis() + ".mp4";
        ...
        videoFileAbsPath = FileUtil.choseSavePath() + File.separator + "pandoravideo.mp4";
