...
import com.donut.app.databinding.ActivityRecordLeftBinding;
...
public class RecordLeftActivity extends MVPBaseActivity<ActivityRecordLeftBinding, ParticularsPresenter> implements ParticularsContract.View {
    ...
    private RelativeLayout mRecordVideoLeft;
    private DonutCameraVideoView mRecordPlayerLeft;
    private JCameraViewLeft mJCameraViewLeft;
    ...
    private BroadcastReceiver mRecordStartReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (CameraContants.ACTION_DONUT_RECORD_START.equals(intent.getAction())) {
                KLog.e("收到开始录制的广播");
                mRecordPlayerLeft.getStartButton().performClick();
            }
        }
    };
    ...
    private BroadcastReceiver mRecordShortReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (CameraContants.ACTION_DONUT_RECORD_SHORT.equals(intent.getAction())) {
                KLog.e("收到录制过短广播");
                mRecordPlayerLeft.onVideoReset();
            }
        }
    };
    ...
    public void onEvent(ParticularsEvent event) {
        ...
        KLog.e("eventbus 中的时间长度++++" + MSG);
    }
    @Override
    protected int getLayoutId() {
        return R.layout.activity_record_left;
    }

    @Override
    protected void initView() {

        mJCameraViewLeft = mViewBinding.jcameraviewLeft;
        mBtnNext = mViewBinding.btnNext;
        mRecordVideoLeft = mViewBinding.recordVideoLeft;
        mRecordPlayerLeft = mViewBinding.recordPlayerLeft;
        mRecordPlayerLeft.setUp(FileUtil.choseSavePath() + File.separator + "download.mp4",false,null);
        ...
        //右侧视频播放
        ViewGroup.LayoutParams frameparams = mViewBinding.recordVideoLeft.getLayoutParams();
        frameparams.width = ScreenUtils.getScreenWidth(this) / 2;
        frameparams.height = ScreenUtils.getScreenWidth(this);
        mRecordVideoLeft.setLayoutParams(frameparams);
...
//        VideoDuration = Integer.parseInt(stringVideoDuration);
    ...
    public void showView(List<ParticularsResponse.ShakingStarListBean> list, ParticularsResponse shakingStarListBeans) {
        KLog.e("showView");
            ...
            mRecordPlayerLeft.setThumbImageView(imageView);
    ...
    public class FFmpegReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if("onProgress".equals(fun)){
                ...
                KLog.e(TAG, "notifyMedia " + fileName + " " + fps + " " + duration);
