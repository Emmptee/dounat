...
public class CaptureButton extends View {
    ...
    public static int buttonState= 0x008;              //当前摄制状态
    ...
    public static final int STATE_CLICK1 = 0x007;         //单击录制
    public static final int STATE_CLICK2 = 0x008;         //长按录制
...
//        min_duration = 6000;              //默认最短录制时间为素材视频时长的80%
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //内圆（浅绿色）
        mPaint.setColor(getResources().getColor(R.color.videoButton));
        ...
        mPaint.setColor(getResources().getColor(R.color.text_next));
        ...
        switch (state) {
            ...
            case STATE_PRESS:
                if (captureLisenter != null && (button_state == JCameraView.BUTTON_STATE_ONLY_CAPTURE || button_state ==
                    ...
                    //内圆缩放动画
                    if (buttonState == STATE_CLICK1){
//                        startCaptureAnimation(button_inside_radius);
                        KLog.e(TAG,"当前是点击按下又抬起");
                        if (captureLisenter != null) {
                            KLog.e(TAG,"点击状态"+captureLisenter);
...
////        );
    ...
    private void startCaptureAnimation(float inside_start) {
        ValueAnimator inside_anim = ValueAnimator.ofFloat(inside_start, inside_start , inside_start);
...
//                if (state == STATE_LONG_PRESS) {
    ...
    public void setClickState(){
        buttonState = STATE_CLICK1;
    }

    public void setPressState(){
        buttonState = STATE_CLICK2;
    }
