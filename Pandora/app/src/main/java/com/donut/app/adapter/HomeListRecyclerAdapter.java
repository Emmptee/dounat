...
import com.donut.app.mvp.home.MyGifView;
...
public class HomeListRecyclerAdapter extends RecyclerView.Adapter<HomeListRecyclerAdapter.ViewHolder>{
    ...
    private List<SweetResponse.HpContentListBean> list;
    private OnItemOnClick onItemOnClick;
    private OnItenShareClick onItenShareClick;
    private Double aDouble;
    public HomeListRecyclerAdapter(Context mContext, List<SweetResponse.HpContentListBean> list) {
            ...
            public void onClick(View v) {
                int position = holder.getAdapterPosition();
                    ...
                    onItenShareClick.OnShareClick(list.get(position).getChannelType(),
                            ...
                            list.get(position).getBrowseTimes(),
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(list.get(position).getBrowseTimes()>=10000){
            ...
            holder.lookcount.setText(bigDecimal.divide(bigDecimal2,2, RoundingMode.HALF_UP)+"万次观看");
        }else{
    ...
    public interface OnItenShareClick{
    ...
    public void setOnItenShareClick(OnItenShareClick onItenShareClick) {
