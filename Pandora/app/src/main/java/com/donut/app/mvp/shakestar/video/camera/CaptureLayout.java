...
import com.donut.app.mvp.shakestar.video.camera.listener.ReturnListener;
...
//    private ImageView iv_custom_right;            //右边自定义按钮
    ...
    public CaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        button_size = (int) (layout_width / 5.36f);
        layout_height = (int)(button_size + button_size /7.5);//外层进度条的宽度+圆的直径
    ...
    private void initView() {
        ...
        btn_capture.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordEnd(long time) {
                if (captureLisenter != null) {
                    KLog.e(TAG, "recordEnd: 摄制结束 state 状态为" + CaptureButton.state);
...
//        txt_tip.setText("轻触拍照，长按摄像");
        txt_tip.setTextColor(getResources().getColor(R.color.videoButton));
