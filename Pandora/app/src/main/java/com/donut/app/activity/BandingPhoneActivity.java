        ...
        mPwdEt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (temp.length() > Constant.LENGTH_32) {
                    ToastUtil.showShort(BandingPhoneActivity.this, getString(R.string.password_check_tip));
            ...
            case R.id.see_pwd_linear:
                if (isShow) {
                    ...
                    Drawable drawable = getResources()
                            .getDrawable(R.drawable.icon_close_white);
                    ...
                    mPwdEt.setTransformationMethod(HideReturnsTransformationMethod
                            .getInstance());
                    Drawable drawable = getResources().getDrawable(R.drawable.icon_open_white);
                    mEyes.setCompoundDrawablesWithIntrinsicBounds(null, null,
                            drawable, null);
                    isShow = true;
                }
...
//        }
        ...
        request.setThirdTag(getIntent().getStringExtra(THIRD_TAG));
        request.setNickName(getIntent().getStringExtra(NICK_NAME));
        request.setPicPath(getIntent().getStringExtra(PIC_PATH));
