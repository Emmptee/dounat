...
public class SaveBehaviourDataService extends IntentService {

    private static final String ACTION = "com.donut.app.service.action.SaveBehaviourData";

    private static final String FUN_CODE = "FUN_CODE";
    private static final String JSON_DATA = "JSON_DATA";
    private static final String HEADER = "HEADER";

    public SaveBehaviourDataService() {
        super("SaveBehaviourDataService");
    }

    public static void startAction(Context context, String funCode) {
        startAction(context, funCode, null, null);
    }

    public static void startAction(Context context, String funCode, Object request, String header) {
        Intent intent = new Intent(context, SaveBehaviourDataService.class);
        intent.setAction(ACTION);
        intent.putExtra(FUN_CODE, funCode);
        if (request != null) {
            intent.putExtra(JSON_DATA, JsonUtils.toJson(request, request.getClass()));
        }
        if (header != null) {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            try {
                saveData(funCode, jsonRequest, header);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void saveData(String funCode, String jsonRequest, String header) throws Exception {
        ...
        baseRequest.setData(jsonRequest);
        ...
        try {
            if (ContextCompat.checkSelfPermission(this,
                ...
                if ("000000000000000".equals(deviceId)) {
                    ...
                    behaviour.setDeviceId(deviceId);
                }
            } else {
                behaviour.setDeviceId(android_id);
            }
        ...
        behaviour.setRequestJson(JsonUtils.toJson(baseRequest,
                BaseRequest.class));
