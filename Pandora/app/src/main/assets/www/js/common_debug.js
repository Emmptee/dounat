...
var baseUrl = "http://172.37.0.2:8080/Donut/";
     ...
     //   "behaviourAction",
      //  [json]);
       // }catch(e){
        //console.log(e);
//}
        console.log("setBehaviourAction");
}
...
//        [msg]);
        alert("跳转登录");
        localStorage.setItem("userId","d8874e7aae214c65bec717b10744b6b7");
        localStorage.setItem("token","d8874e7aae214c65bec717b10744b6b7");
        localStorage.setItem("vipFlg","0");
}
